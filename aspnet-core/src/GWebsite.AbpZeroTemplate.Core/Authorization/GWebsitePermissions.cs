namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public static class GWebsitePermissions
    {
        ...
        public const string Pages_Administration_Xiaomi = "Pages.Administration.Xiaomi";
        public const string Pages_Administration_Xiaomi_Create = "Pages.Administration.Xiaomi.Create";
        public const string Pages_Administration_Xiaomi_Edit = "Pages.Administration.Xiaomi.Edit";
        public const string Pages_Administration_Xiaomi_Delete = "Pages.Administration.Xiaomi.Delete";
