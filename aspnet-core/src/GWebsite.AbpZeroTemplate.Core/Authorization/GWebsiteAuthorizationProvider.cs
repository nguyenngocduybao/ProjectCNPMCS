...
namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public class GWebsiteAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var xiaomi = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_Xiaomi, L("Xiaomi"));
            xiaomi.CreateChildPermission(GWebsitePermissions.Pages_Administration_Xiaomi_Create, L("CreatingNewXiaomi"));
            xiaomi.CreateChildPermission(GWebsitePermissions.Pages_Administration_Xiaomi_Edit, L("EditingXiaomi"));
            xiaomi.CreateChildPermission(GWebsitePermissions.Pages_Administration_Xiaomi_Delete, L("DeletingXiaomi"));
